...
# Show the wallpaper selection menu in Rofi with the Gruvbox theme
selected_wallpaper=$(echo "$wallpapers" | rofi -dmenu -i -p "Select Wallpaper" -theme "~/.config/rofi/colors/gruvbox.rasi")
